...
def nlp_model(v_id):
    ...
    if (transcript == '0'):
        ...
        telugu_translated_summary = g_translate(english_summary, 'te')
        ...
        makeTextFile("Telugu", telugu_translated_summary)

        return original_text_length, final_summary_length, english_summary, hindi_translated_summary, gujarati_translated_summary, telugu_translated_summary
